...
Puppet::Type.newtype(:dsc_waitforcertificateservices) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC WaitForCertificateServices resource type.
    Automatically generated from
    'CertificateDsc/DSCResources/MSFT_WaitForCertificateServices/MSFT_WaitForCertificateServices.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'WaitForCertificateServices' end
  def dscmeta_resource_name; 'MSFT_WaitForCertificateServices' end
...
Puppet::Type.type(:dsc_waitforcertificateservices).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
