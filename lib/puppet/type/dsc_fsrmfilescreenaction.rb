...
Puppet::Type.newtype(:dsc_fsrmfilescreenaction) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC FSRMFileScreenAction resource type.
    Automatically generated from
    'FSRMDsc/DSCResources/DSR_FSRMFileScreenAction/DSR_FSRMFileScreenAction.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'FSRMFileScreenAction' end
  def dscmeta_resource_name; 'DSR_FSRMFileScreenAction' end
  ...
  newparam(:dsc_path) do
    ...
    desc "Path - The path of the FSRM File Screen the action applies to."
    isrequired
    validate do |value|
  ...
  newparam(:dsc_shouldlogerror) do
    ...
    def mof_is_embedded?; false end
    desc "ShouldLogError - The working directory of the command. Required when Type is Command."
    validate do |value|
    end
  ...
  newparam(:dsc_workingdirectory) do
    def mof_type; 'string' end
    def mof_is_embedded?; false end
    desc "WorkingDirectory - The type of event created. Required when Type is Event."
    validate do |value|
      unless value.kind_of?(String)
        fail("Invalid value '#{value}'. Should be a string")
      end
...
Puppet::Type.type(:dsc_fsrmfilescreenaction).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
