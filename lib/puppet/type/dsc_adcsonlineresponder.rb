...
Puppet::Type.newtype(:dsc_adcsonlineresponder) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC AdcsOnlineResponder resource type.
    Automatically generated from
    'ActiveDirectoryCSDsc/DSCResources/MSFT_AdcsOnlineResponder/MSFT_AdcsOnlineResponder.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'AdcsOnlineResponder' end
  def dscmeta_resource_name; 'MSFT_AdcsOnlineResponder' end
...
Puppet::Type.type(:dsc_adcsonlineresponder).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
