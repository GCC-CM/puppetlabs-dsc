...
Puppet::Type.newtype(:dsc_scheduledtask) do
  ...
  @doc = %q{
    ...
    'ComputerManagementDsc/DSCResources/MSFT_ScheduledTask/MSFT_ScheduledTask.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'ScheduledTask' end
  def dscmeta_resource_name; 'MSFT_ScheduledTask' end
...
Puppet::Type.type(:dsc_scheduledtask).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
