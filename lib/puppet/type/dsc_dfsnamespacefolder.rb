...
Puppet::Type.newtype(:dsc_dfsnamespacefolder) do
  ...
  @doc = %q{
    ...
    'DFSDsc/DSCResources/MSFT_DFSNamespaceFolder/MSFT_DFSNamespaceFolder.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'DFSNamespaceFolder' end
  def dscmeta_resource_name; 'MSFT_DFSNamespaceFolder' end
...
Puppet::Type.type(:dsc_dfsnamespacefolder).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
