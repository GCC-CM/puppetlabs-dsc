...
Puppet::Type.newtype(:dsc_adcscertificationauthority) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC AdcsCertificationAuthority resource type.
    Automatically generated from
    'ActiveDirectoryCSDsc/DSCResources/MSFT_AdcsCertificationAuthority/MSFT_AdcsCertificationAuthority.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'AdcsCertificationAuthority' end
  def dscmeta_resource_name; 'MSFT_AdcsCertificationAuthority' end
...
Puppet::Type.type(:dsc_adcscertificationauthority).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
