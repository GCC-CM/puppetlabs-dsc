...
Puppet::Type.newtype(:dsc_fsrmquotaaction) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC FSRMQuotaAction resource type.
    Automatically generated from
    'FSRMDsc/DSCResources/DSR_FSRMQuotaAction/DSR_FSRMQuotaAction.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'FSRMQuotaAction' end
  def dscmeta_resource_name; 'DSR_FSRMQuotaAction' end
  ...
  newparam(:dsc_path) do
    ...
    desc "Path - The path of the FSRM Quota the action applies to."
    isrequired
    validate do |value|
...
Puppet::Type.type(:dsc_fsrmquotaaction).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
