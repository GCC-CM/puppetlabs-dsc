...
Puppet::Type.newtype(:dsc_certificateexport) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC CertificateExport resource type.
    Automatically generated from
    'CertificateDsc/DSCResources/MSFT_CertificateExport/MSFT_CertificateExport.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'CertificateExport' end
  def dscmeta_resource_name; 'MSFT_CertificateExport' end
...
Puppet::Type.type(:dsc_certificateexport).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
