...
Puppet::Type.newtype(:dsc_dfsreplicationgroupconnection) do
  ...
  @doc = %q{
    ...
    'DFSDsc/DSCResources/MSFT_DFSReplicationGroupConnection/MSFT_DFSReplicationGroupConnection.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'DFSReplicationGroupConnection' end
  def dscmeta_resource_name; 'MSFT_DFSReplicationGroupConnection' end
...
Puppet::Type.type(:dsc_dfsreplicationgroupconnection).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
