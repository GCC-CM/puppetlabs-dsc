...
Puppet::Type.newtype(:dsc_fsrmfilescreenexception) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC FSRMFileScreenException resource type.
    Automatically generated from
    'FSRMDsc/DSCResources/DSR_FSRMFileScreenException/DSR_FSRMFileScreenException.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'FSRMFileScreenException' end
  def dscmeta_resource_name; 'DSR_FSRMFileScreenException' end
...
Puppet::Type.type(:dsc_fsrmfilescreenexception).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
