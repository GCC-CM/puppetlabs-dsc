...
Puppet::Type.newtype(:dsc_fsrmautoquota) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC FSRMAutoQuota resource type.
    Automatically generated from
    'FSRMDsc/DSCResources/DSR_FSRMAutoQuota/DSR_FSRMAutoQuota.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'FSRMAutoQuota' end
  def dscmeta_resource_name; 'DSR_FSRMAutoQuota' end
...
Puppet::Type.type(:dsc_fsrmautoquota).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
