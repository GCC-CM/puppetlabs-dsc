...
Puppet::Type.newtype(:dsc_virtualmemory) do
  ...
  @doc = %q{
    ...
    'ComputerManagementDsc/DSCResources/MSFT_VirtualMemory/MSFT_VirtualMemory.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'VirtualMemory' end
  def dscmeta_resource_name; 'MSFT_VirtualMemory' end
...
Puppet::Type.type(:dsc_virtualmemory).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
