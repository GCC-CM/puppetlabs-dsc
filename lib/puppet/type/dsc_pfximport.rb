...
Puppet::Type.newtype(:dsc_pfximport) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC PfxImport resource type.
    Automatically generated from
    'CertificateDsc/DSCResources/MSFT_PfxImport/MSFT_PfxImport.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'PfxImport' end
  def dscmeta_resource_name; 'MSFT_PfxImport' end
...
Puppet::Type.type(:dsc_pfximport).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
