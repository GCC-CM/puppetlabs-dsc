...
Puppet::Type.newtype(:dsc_dfsnamespaceroot) do
  ...
  @doc = %q{
    ...
    'DFSDsc/DSCResources/MSFT_DFSNamespaceRoot/MSFT_DFSNamespaceRoot.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'DFSNamespaceRoot' end
  def dscmeta_resource_name; 'MSFT_DFSNamespaceRoot' end
...
Puppet::Type.type(:dsc_dfsnamespaceroot).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
