...
Puppet::Type.newtype(:dsc_dfsreplicationgroup) do
  ...
  @doc = %q{
    ...
    'DFSDsc/DSCResources/MSFT_DFSReplicationGroup/MSFT_DFSReplicationGroup.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'DFSReplicationGroup' end
  def dscmeta_resource_name; 'MSFT_DFSReplicationGroup' end
...
Puppet::Type.type(:dsc_dfsreplicationgroup).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
