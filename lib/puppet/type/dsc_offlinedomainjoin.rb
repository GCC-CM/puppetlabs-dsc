...
Puppet::Type.newtype(:dsc_offlinedomainjoin) do
  ...
  @doc = %q{
    ...
    'ComputerManagementDsc/DSCResources/MSFT_OfflineDomainJoin/MSFT_OfflineDomainJoin.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'OfflineDomainJoin' end
  def dscmeta_resource_name; 'MSFT_OfflineDomainJoin' end
...
Puppet::Type.type(:dsc_offlinedomainjoin).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
