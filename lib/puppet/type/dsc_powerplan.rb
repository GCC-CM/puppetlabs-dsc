...
Puppet::Type.newtype(:dsc_powerplan) do
  ...
  @doc = %q{
    ...
    'ComputerManagementDsc/DSCResources/MSFT_PowerPlan/MSFT_PowerPlan.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'PowerPlan' end
  def dscmeta_resource_name; 'MSFT_PowerPlan' end
...
Puppet::Type.type(:dsc_powerplan).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
