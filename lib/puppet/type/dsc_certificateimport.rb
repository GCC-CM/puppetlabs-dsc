...
Puppet::Type.newtype(:dsc_certificateimport) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC CertificateImport resource type.
    Automatically generated from
    'CertificateDsc/DSCResources/MSFT_CertificateImport/MSFT_CertificateImport.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'CertificateImport' end
  def dscmeta_resource_name; 'MSFT_CertificateImport' end
...
Puppet::Type.type(:dsc_certificateimport).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
