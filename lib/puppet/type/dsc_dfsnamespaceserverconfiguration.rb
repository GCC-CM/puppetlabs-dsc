...
Puppet::Type.newtype(:dsc_dfsnamespaceserverconfiguration) do
  ...
  @doc = %q{
    ...
    'DFSDsc/DSCResources/MSFT_DFSNamespaceServerConfiguration/MSFT_DFSNamespaceServerConfiguration.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'DFSNamespaceServerConfiguration' end
  def dscmeta_resource_name; 'MSFT_DFSNamespaceServerConfiguration' end
...
Puppet::Type.type(:dsc_dfsnamespaceserverconfiguration).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
