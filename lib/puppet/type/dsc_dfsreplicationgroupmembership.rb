...
Puppet::Type.newtype(:dsc_dfsreplicationgroupmembership) do
  ...
  @doc = %q{
    ...
    'DFSDsc/DSCResources/MSFT_DFSReplicationGroupMembership/MSFT_DFSReplicationGroupMembership.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'DFSReplicationGroupMembership' end
  def dscmeta_resource_name; 'MSFT_DFSReplicationGroupMembership' end
...
Puppet::Type.type(:dsc_dfsreplicationgroupmembership).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
