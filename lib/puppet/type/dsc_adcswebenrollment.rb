...
Puppet::Type.newtype(:dsc_adcswebenrollment) do
  require Pathname.new(__FILE__).dirname + '../../' + 'puppet/type/base_dsc'
  require Pathname.new(__FILE__).dirname + '../../puppet_x/puppetlabs/dsc_type_helpers'


  @doc = %q{
    The DSC AdcsWebEnrollment resource type.
    Automatically generated from
    'ActiveDirectoryCSDsc/DSCResources/MSFT_AdcsWebEnrollment/MSFT_AdcsWebEnrollment.schema.mof'
  ...
  def dscmeta_resource_friendly_name; 'AdcsWebEnrollment' end
  def dscmeta_resource_name; 'MSFT_AdcsWebEnrollment' end
...
Puppet::Type.type(:dsc_adcswebenrollment).provide :powershell, :parent => Puppet::Type.type(:base_dsc).provider(:powershell) do
